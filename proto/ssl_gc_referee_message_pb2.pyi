...
class GameEventProposalGroup(_message.Message):
    ...
    game_events: _containers.RepeatedCompositeFieldContainer[_ssl_gc_game_event_pb2.GameEvent]
    accepted: bool
    def __init__(self, id: _Optional[str] = ..., game_events: _Optional[_Iterable[_Union[_ssl_gc_game_event_pb2.GameEvent, _Mapping]]] = ..., accepted: _Optional[bool] = ...) -> None: ...
