from proto import ssl_gc_common_pb2 as _ssl_gc_common_pb2
...
class GameEvent(_message.Message):
    ...
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        BOT_DROPPED_PARTS: _ClassVar[GameEvent.Type]
        ...
        EXCESSIVE_BOT_SUBSTITUTION: _ClassVar[GameEvent.Type]
        ...
        CHALLENGE_FLAG_HANDLED: _ClassVar[GameEvent.Type]
    ...
    class BotKickedBallTooFast(_message.Message):
        ...
        chipped: bool
        def __init__(self, by_team: _Optional[_Union[_ssl_gc_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_gc_geometry_pb2.Vector2, _Mapping]] = ..., initial_ball_speed: _Optional[float] = ..., chipped: _Optional[bool] = ...) -> None: ...
    ...
    class PlacementFailed(_message.Message):
        __slots__ = ("by_team", "remaining_distance", "nearest_own_bot_distance")
        BY_TEAM_FIELD_NUMBER: _ClassVar[int]
    ...
    class ChallengeFlagHandled(_message.Message):
        __slots__ = ("by_team", "accepted")
        BY_TEAM_FIELD_NUMBER: _ClassVar[int]
        ACCEPTED_FIELD_NUMBER: _ClassVar[int]
        by_team: _ssl_gc_common_pb2.Team
        accepted: bool
        def __init__(self, by_team: _Optional[_Union[_ssl_gc_common_pb2.Team, str]] = ..., accepted: _Optional[bool] = ...) -> None: ...
